...
{
    const AUDIO_UPLOAD_PATH = '/public/song/audio';
    const AUDIO_PROPERTY = 'audio';
    use THasAudio;
    ...
    static protected $schema = [
        ...
        'relations' => [
            'artist' => ['type' => self::BELONGS_TO, 'model' => Artist::class]
        ]
    ...
    public static function findAllSortedBash()
    {
        ...
        $sorted = $songs->sort(
            ...
            function ($a, $b) {
                ...
                return $alphabet[substr($a->title, 0, 2)] <=> $alphabet[substr($b->title, 0, 2)];
            }
        );
        return $sorted;
    }
